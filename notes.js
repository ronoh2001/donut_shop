...
function donutShop(loc, minCPH, maxCPH, Avg) {
    ...
    this.donutsPerDay = donutsPerDay;
  ...
  this.donutsPerHour = function() {
    for (var i = 0; i < 11; i++) {
     var hourly = Math.round(this.randomCustomers() * this.Avg);
  ...
  var Ballard = new donutShop ('Ballard', 8, 58, 3.75);
   ...
   var tableDataSix = document.createElement('td');
   ...
   var b = document.getElmentById('randomize');
